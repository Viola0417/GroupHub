    ...
    <div class="box content">
        <c:choose>
            <c:when test="${bookRate.getRateScore()==0}">
                <div class="review">
                    <!--this user has not added rate to this book before-->
            ...
            <c:otherwise>
                <!-- this user has added rate to this book-->
                <div class="review">
                    <form name="updateBookRateForm" action="/rate/updateBookRate" method="post" onsubmit="return validateUpdateFormNotNull()">
                        <div>
                            <div class="page-header" style="font-size: 30px; color: #01c6a9; font-weight: 650"> Your previous rating was ${bookRate.getRateScore()}</div> <br>
                        ...
                        <div>
                            ...
                            <input  class="reviewInput" id="newRateTitle" name="newRateTitle" type="text" size="100" value="${bookRate.getRateTitle()}"/>
                            <br><br>
                            <textarea class="reviewInput" id="newRateContent" name="newRateContent" rows="9" cols="100">${bookRate.getRateContent()}</textarea>
                            <br><br>
                            <div style="display: flex; justify-content: center">
