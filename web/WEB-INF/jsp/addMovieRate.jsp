    ...
    <c:choose>
        ...
        <div class="review">
            <form name="updateMovieRateForm" action="/rate/updateMovieRate" method="post" onsubmit="return validateUpdateFormNotNull()">
                <div>
                    <div class="page-header" style="font-size: 30px; color: #01c6a9; font-weight: 650"> Your previous rating was ${movieRate.getRateScore()}</div> <br>
                ...
                <div>
                    ...
                    <input  class="reviewInput" id="newRateTitle" name="newRateTitle" type="text" size="100" value="${movieRate.getRateTitle()}"/>
                    <br><br>
                    <textarea class="reviewInput" id="newRateContent" name="newRateContent" rows="9" cols="100">${movieRate.getRateContent()}</textarea>
                    <br><br>
                    <div style="display: flex; justify-content: center">
