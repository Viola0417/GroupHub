    ...
    <div class="container">
        ...
        <div id="navbarMenu" class="navbar-menu">
            <div class="navbar-end">
                <form class="navbar-item"  action="/admin/toAdminModifyPassword" method="post">
                    <button class="kt-button" type="submit">Modify Password</button>
                </form>
                <form class="navbar-item" action="/admin/logOff" method="post">
    ...
    <nav class="navbar is-white">
        <div class="navbar-end">
            <div class="navbar-item">
                <a href="${pageContext.request.contextPath}/request/adminCheckUnresolvedRequest" class="kt-button" style="font-weight: 800; font-size: 15px">Unresolved Request(${unresolvedRequests})</a>
            </div>
        </div>
    </nav>
</div>
    ...
    <div class="section">
        <div class="columns">
            <div class="column has-text-centered">
                <h1 class="title">Hi ${adminName}!</h1><br>
            </div>
        </div>
