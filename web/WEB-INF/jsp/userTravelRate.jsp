        ...
        <div class="commentBox">
            <div class="commentText">
                ...
                <c:if test="${userName eq topComment.key.commentAuthor}">
                    &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/comment/userDeleteTravelComment?commentId=${topComment.key.getCommentId()}">Delete</a>
                    &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/comment/userToUpdateTravelComment?commentId=${topComment.key.getCommentId()}">Update</a>
                </c:if>
                <br>
                <c:choose>
                    <c:when test="${modifyComment eq 1 && topComment.key.commentId eq commentId}">
                        <form name="updateCommentForm" action="/comment/userUpdateTravelComment" method="post"
                ...
                <c:forEach items="${topComment.value}" var="replyComment">
                    ...
                    <c:if test="${userName eq replyComment.commentAuthor}">
                        &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/comment/userDeleteTravelComment?commentId=${replyComment.getCommentId()}">Delete</a>
                        &nbsp;&nbsp;<a href="${pageContext.request.contextPath}/comment/userToUpdateTravelComment?commentId=${replyComment.getCommentId()}">Update</a>
                    </c:if>
                    ...
                    <c:choose>
                        <c:when test="${modifyComment eq 1 && replyComment.commentId eq commentId}">
                            <form name="updateReplyForm" action="/comment/userUpdateTravelComment" method="post"
