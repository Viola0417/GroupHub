            ...
            <div class="review">
                <form name="addBookForm" action="/book/addBook" method="post" onsubmit="return validateFormNotNull()">
                    <div style="text-align: center">
                        ...
                        <a href="/book/toBook" type="hidden" style="font-size: 20px;">${msg}</a>
                    </div>
                    <br><h3 style="display: inline; font-size: 23px; ">Book Title</h3>&emsp;
                    <input class="reviewInput" id="bookName" name="bookName" type="text" width="100" placeholder="Add title here"/>
                    <br><br><br><h3 style="display: inline; font-size: 23px; ">Book Author</h3>&emsp;
                    <input class="reviewInput" id="bookAuthor" name="bookAuthor" type="text" width="100" placeholder="Add book author here"/>
                    <br><br><br><h3 style="display: inline; font-size: 23px; ">Book Description </h3><br><br>
                    <textarea class="reviewInput" id="bookDescription" name="bookDescription" rows="10" cols="100" placeholder="Add description here"></textarea>
                    <br><br><br>
