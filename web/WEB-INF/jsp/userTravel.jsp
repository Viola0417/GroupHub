            ...
            <div class="navbar-menu">
                ...
                <div class="navbar-end">
                    <div class="navbar-item">
                        <form action="${pageContext.request.contextPath}/travel/userQueryTravel" method="post" class="search-box-wrapper">
                            <input type="text" name="queryTravelName" class="search-box-input" placeholder="Travel Destination">
