...
<html>
<head>
    <title>User Modify Password Page</title>
...
<div>
    ...
    <div class="review">
    <form name="modifyPasswordForm" action="${pageContext.request.contextPath}/user/modifyPassword" method="post"
        ...
        <div style="display: flex; justify-content: center">
            <button class="kt-button" type="submit">submit</button></div>
        <br><span style="color:red;font-weight: bold">${modifyError}</span>
    </form>
    </div>
    <a href="${pageContext.request.contextPath}/user/toUserFunction" type="hidden">${returnMsg}</a>
</div>
    </div>
</div>
</body>
