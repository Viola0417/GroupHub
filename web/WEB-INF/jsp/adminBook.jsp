                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <div class="navbar-item">
                            <h2>
                                <a class="kt-button" href="${pageContext.request.contextPath}/book/toAddBook">add book</a>
                            </h2>
                        </div>
                    </div>
                </div>
                        ...
                        <c:forEach var="book" items="${requestScope.get('bookList')}">
                            <tr>
                                ...
                                <td class="rate">
                                    ...
                                    <a href="${pageContext.request.contextPath}/book/deleteBook?bookId=${book.getBookId()}">Delete</a><br>
