            ...
            <div class="navbar-menu">
                ...
                <div class="navbar-end">
                    <div class="navbar-item">
                        <form action="${pageContext.request.contextPath}/book/userQueryBook" method="post" class="search-box-wrapper">
                            <input type="text" name="queryBookName" class="search-box-input" placeholder="Book Name">
            ...
            <div class="table100 ver1 m-b-110">
                <table data-vertable="ver1">
                    ...
                    <tr class="row100 head">
                        <th class="column100 column3">Book Name</th>
                        <th class="column100 column2">Book Author</th>
                    ...
                    <c:forEach var="book" items="${requestScope.get('bookList')}">
                        <tr>
                            <td class="column100 column3">${book.getBookName()}</td>
                            <td class="column100 column2">${book.getBookAuthor()}</td>
                            <td class="column100 column1">${book.getDescription()}</td>
                            <td class="column100 column4">${book.getTotalRateNumber()}</td>
                            <td>
                                <c:choose>
                            ...
                            <td class="rate">
                                <a href="${pageContext.request.contextPath}/rate/toBookRate?bookId=${book.getBookId()}">Rate</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
